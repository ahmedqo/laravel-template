    ...
    <div class="w-full flex flex-col gap-6">
        <div class="flex flex-col gap-4">
            ...
            <ul class="grid grid-rows-1 grid-cols-2 lg:grid-cols-4 gap-4">
                <li
                    class="bg-x-white rounded-x-huge shadow-x-core p-4 lg:p-6 flex gap-2 flex-col items-center lg:flex-row lg:flex-wrap">
                    <svg class="block w-12 h-12 lg:w-16 lg:h-16 pointer-events-none" style="color: var(--color-0);"
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-end">
                        <h2 class="text-sm lg:text-base text-x-black font-x-huge">{{ __('Total') }}</h2>
                        <p class="text-base lg:text-base text-gray-800">00</p>
                    </div>
                </li>
                <li
                    class="bg-x-white rounded-x-huge shadow-x-core p-4 lg:p-6 flex gap-2 flex-col items-center lg:flex-row lg:flex-wrap">
                    <svg class="block w-12 h-12 lg:w-16 lg:h-16 pointer-events-none" style="color: var(--color-3);"
                        fill="currentcolor" viewBox="0 -960 960 960">
                        <path
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-end">
                        <h2 class="text-sm lg:text-base text-x-black font-x-huge">{{ __('Products') }}</h2>
                        <p class="text-base lg:text-base text-gray-800">00</p>
                    </div>
                </li>
                <li
                    class="bg-x-white rounded-x-huge shadow-x-core p-4 lg:p-6 flex gap-2 flex-col items-center lg:flex-row lg:flex-wrap">
                    <svg class="block w-12 h-12 lg:w-16 lg:h-16 pointer-events-none" style="color: var(--color-4);"
                        fill="currentcolor" viewBox="0 -960 960 960">
                        <path
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-end">
                        <h2 class="text-sm lg:text-base text-x-black font-x-huge">{{ __('Quotations') }}</h2>
                        <p class="text-base lg:text-base text-gray-800">00</p>
                    </div>
                </li>
                <li
                    ...
                    <div class="flex flex-1 flex-col items-center lg:items-end">
                        <h2 class="text-sm lg:text-base text-x-black font-x-huge">{{ __('Requests') }}</h2>
                        <p class="text-base lg:text-base text-gray-800">00</p>
                    </div>
                </li>
            </ul>
