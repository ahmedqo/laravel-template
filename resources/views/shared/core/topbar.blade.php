<neo-topbar transparent align="space-between" class="bg-x-prime md:bg-transparent shadow-x-core md:shadow-none md:py-4">
    <div class="lg:flex-1 flex flex-wrap gap-4 items-center">
        <button id="trigger" onclick="sidebar.toggle()" aria-label="sidebar_trigger"
            class="flex items-center justify-center w-6 h-6 text-x-white md:text-x-black outline-none relative isolate before:content-[''] before:rounded-x-thin before:absolute before:block before:w-[130%] before:h-[130%] before:-inset-[15%] before:-z-[1] before:!bg-opacity-40 hover:before:bg-x-shade focus:before:bg-x-shade focus-within:before:bg-x-shade">
    ...
    <h1 class="lg:flex-[3] me-auto md:me-0 lg:text-center text-x-white md:text-x-black font-x-thin text-xl lg:text-2xl">
        @yield('title')
    </h1>
    <div class="lg:flex-1 items-center justify-end flex flex-wrap gap-4">
