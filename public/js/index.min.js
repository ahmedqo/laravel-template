function capitalize(t){return"string"!=typeof t||0===t.length?t:t.charAt(0).toUpperCase()+t.slice(1)}OS.$Load(function(){document.body.removeAttribute("close");let t=document.querySelector("#trigger"),e=document.querySelector("os-sidebar");t&&e&&t.addEventListener("click",t=>{e.toggle()}),document.querySelectorAll(".nav-colors svg").forEach((t,e)=>{e<10&&(t.style.color="var(--color-"+e+")")}),document.querySelectorAll(".sys-colors svg").forEach((t,e)=>{e<10&&(t.style.color="var(--color-sys-"+e+")")})}),function(){let t=`
        :host {
            gap: 1px;
            display: flex;
            margin: 0 auto;
